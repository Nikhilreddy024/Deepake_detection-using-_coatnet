...
dir_path = r"C:\Users\msair\Downloads\CN-main\CN-main\preprocessing\data/" 
train_path = "face_data/train"
validation_path = "face_data/validation"
...
def extract_face(dir_path):
    ...
    for item in sorted(os.listdir(dir_path)):
        ...
        print(f"Processing item: {item}, file_num: {file_num}")
        ...
        print(f"Meta full path: {meta_full_path}")
        
        if os.path.isdir(meta_full_path):
            data = load_metadata(meta_full_path+'/')
            print(f"Data loaded for item: {item}")
                ...
                for filename in filtered_files:
                    try:
                        ...
                        if filename.endswith(".mp4") and os.path.isfile(dir_path+item+'/'+filename):
                            ...
                            print(f"Processing video: {dir_path+item+'/'+filename}")
...
def process_video(video_path, filename, image_path, original):
    ...
    facedet.load_weights(r"C:\Users\msair\Downloads\CN-main\CN-main\helpers\blazeface.pth")
    facedet.load_anchors(r"C:\Users\msair\Downloads\CN-main\CN-main\helpers\anchors.npy")
